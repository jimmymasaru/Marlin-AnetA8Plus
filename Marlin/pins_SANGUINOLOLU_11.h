...
#define SDSS               31
  ...
  #define CASE_LIGHT_PIN        -1 //4   // MUST BE HARDWARE PWM  - see if IO Header is available
#endif
...
//
        ...
        #define LCD_PINS_RS     27   //30 // CS chip select /SS chip slave select
        #define LCD_PINS_ENABLE 28   //29 // SID (MOSI)
        #define LCD_PINS_D4     30   //17 // SCK (CLK) clock
        // Pin 27 is taken by LED_PIN, but Melzi LED does nothing with
        // Marlin so this can be used for BEEPER_PIN. You can use this pin
        // with M42 instead of BEEPER_PIN.
        #define BEEPER_PIN      17   //27
  ...
  #if ENABLED(LCD_I2C_PANELOLU2)
    #if IS_MELZI
      #define BTN_ENC           16    //29
      #define LCD_SDSS          31   //30 // Panelolu2 SD card reader rather than the Melzi
    #else
      #define BTN_ENC           30
    #endif
  #else  // !Panelolu2
